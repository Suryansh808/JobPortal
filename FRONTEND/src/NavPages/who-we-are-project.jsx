...
const WhoweareProject = () => {
  return (
    ...
    <div id="mainpage">
        ...
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab adipisci recusandae excepturi nobis eos qui tempora quam nesciunt, dolorem voluptas corrupti consequuntur, vitae distinctio blanditiis mollitia magni impedit quisquam optio.</p>
        </div>
