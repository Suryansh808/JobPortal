...
const RejectedCandidates = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
     ...
     const rejectedApplications = fetchedApplications.filter(app => app.statusByCompany !== 'Rejected' && app.statusByCompany !== "Hired");
  ...
  <h2 className="text-2xl font-bold mb-4 text-white">Applicants Pendind By Company</h2>
